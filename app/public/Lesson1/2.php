...
<body>
<?php
if (!isset($_GET['r']) && !isset($_GET['g']) && !isset($_GET['b'])) $rgb = "";
else {
  $r = (isset($_GET['r']) && $_GET['r'] == "") ? 0 : $_GET['r'];
  $g = (isset($_GET['g']) && $_GET['g'] == "") ? 0 : $_GET['g'];
  $b = (isset($_GET['b']) && $_GET['b'] == "") ? 0 : $_GET['b'];
  $rgb = $r . "," . $g . "," . $b;
}
?>
<div class="container">
  ...
  <div class="row">
    <div class="col-3 rounded p-2" style="background-color: rgb(<?= $rgb ?>)">
